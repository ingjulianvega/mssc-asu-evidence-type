...
public class MvcExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public MvcExceptionHandler(EvidenceTypeParameters evidenceTypeParameters) {
        this.evidenceTypeParameters = evidenceTypeParameters;
    }

    EvidenceTypeParameters evidenceTypeParameters;


    @ExceptionHandler(EvidenceTypeException.class)
    public ResponseEntity<ApiError> validationErrorHandler(EvidenceTypeException ame) {
        ApiError apiError = ApiError
                .builder()
                .timestamp(LocalDateTime.now())
                .api(evidenceTypeParameters.getApi())
